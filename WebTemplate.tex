...
\begin{wrapfigure}{r}{0.5\linewidth}
	...
	\newline
	\vspace{-.6cm}
	\center{\adjincludegraphics[width = 1\linewidth,trim={0cm 0cm 0cm 0cm},clip]{PortfolioOverviewGraphs_Portfolio_InvestmentClassAssessment.png}	}
	\vspace{-2.2cm}
	\newline
...
\fcolorbox{black}{white}{ 
	...
	\includegraphics[width=1\linewidth]{PortfolioOverviewGraphs_Portfolio_SectorWeights.png}}
}
\end{minipage}
\hspace{.5cm} %EQPieE
...
\begin{wrapfigure}{t}{0.5\linewidth}
	\vspace{-.45cm}
	\textbf{CaptionP5}
	\center{\includegraphics[trim={0 0cm 0 0 },clip,width=.8\linewidth]{ReportGraphics/FigureP4a_EN}}
	\vspace{-1.4cm}
\end{wrapfigure}

ContentP5

{\centering\includegraphics[trim={0 .6cm 0 1.2cm},clip,width=.8\linewidth]{ReportGraphics/FigureP4b_EN}\par}
...
\begin{minipage}[t]{.48\linewidth}
	...
	\includegraphics[trim={0 0 0 0cm},clip,width=1\linewidth]{ReportGraphics/Figure_Feedback_a_EN}
\end{minipage}
\hspace{.02\linewidth}
\begin{minipage}[t]{.48\linewidth}
	\centering \textit{ContentP005e}
	
	\includegraphics[trim={0 0 0 0},clip,width=1\linewidth]{ReportGraphics/Figure_Feedback_b_EN}
\end{minipage}
...
\includegraphics[width=1\linewidth,trim={0 0cm 0 0},clip]{ReportGraphics/FigureP5_EN}
\newpage
...
\fcolorbox{black}{white}{ 	
	...
	\vspace{0cm}
	\includegraphics[trim={0 .7cm 0 0},clip,width=1\linewidth]{SectorGraphs_PowerSector_TechnologyMix.png}
	\vspace{-0.5cm}
	\newline
	\begin{minipage}[t]{.32\linewidth}
		\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_RenewablesPower.png}
		\textbf{CaptionWeight TechRenewablesCap EQCaptionRenewablesCap} %RenewablesCapEQCaption
	\end{minipage}	
		\hspace{.01\linewidth}
	\begin{minipage}[t]{.32\textwidth}
		\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_GasPower.png}	
		\textbf{CaptionWeight TechGasCap EQCaptionGasCap} %GasCapEQCaption
	\end{minipage}
		\hspace{.01\linewidth}
	\begin{minipage}[t]{.32\linewidth}
		\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_CoalPower.png}
		\textbf{CaptionWeight TechCoalCap EQCaptionCoalCap} %CoalCapEQCaption
	\end{minipage}		
	
	{\centering\includegraphics[trim={0 .3cm 0 0.3cm},clip,width=.6\linewidth]{ReportGraphics/LineChartLegend_EN}\par}

}}

ContentTech2

\fbox{\includegraphics[trim={0 0.9cm 0 0.8cm},clip,width=1\linewidth]{SectorGraphs_Power_PortfolioRanking.png}}
...
\fcolorbox{black}{white}{ 	
	\parbox{1\linewidth}{
		...
		\vspace{0cm}
		\includegraphics[trim={0 .7cm 0 0},clip,width=1\linewidth]{SectorGraphs_FossilFuelsSector_TechnologyMix.png}
		\vspace{-0.5cm}
		\newline
		\begin{minipage}[t]{.32\linewidth}
			\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_OilProduction.png
			}
			\textbf{CaptionWeight TechOilProd EQCaptionOilProd}
		\end{minipage}	
		\hspace{.01\linewidth}
		\begin{minipage}[t]{.32\textwidth}
			\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_GasProduction.png}	
			\textbf{CaptionWeight TechGasProd EQCaptionGasProd}
		\end{minipage}
		\hspace{.01\linewidth}
		\begin{minipage}[t]{.32\linewidth}
			\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_CoalProduction.png}
...
\fbox{\includegraphics[trim={0 0.9cm 0 0.8cm},clip,width=1\linewidth]{SectorGraphs_FossilFuels_PortfolioRanking.png}}
...
\fcolorbox{black}{white}{ 	
	\parbox{1\linewidth}{
		...
		\vspace{0cm}
		\includegraphics[trim={0 .7cm 0 0},clip,width=1\linewidth]{SectorGraphs_AutomotiveSector_TechnologyMix.png}
		\vspace{-0.5cm}
		\newline
		\begin{minipage}[t]{.32\linewidth}
			\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_ICECarProduction.png}
			\textbf{CaptionWeight TechICE EQCaptionICE}
		\end{minipage}	
		\hspace{.01\linewidth}
		\begin{minipage}[t]{.32\textwidth}
			\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_ElectricCarProduction.png}	
			\textbf{CaptionWeight TechHybrid EQCaptionHybrid}
			
		\end{minipage}
		\hspace{.01\linewidth}
		\begin{minipage}[t]{.32\linewidth}
			\includegraphics[trim = {0 0cm 0 0},width=1\linewidth]{TechnologyGraphs_TechnologyAlignment_HybridCarProduction.png}
...
\fbox{\includegraphics[trim={0 0.9cm 0 0.8cm},clip,width=1\linewidth]{SectorGraphs_Automotive_PortfolioRanking.png}}
...
\fcolorbox{black}{white}{ 
\includegraphics[trim={0 0.8cm 0 0.8cm},clip,width=1\linewidth]{SectorGraphs_Overview_PortfolioRanking.png}}
...
\begin{minipage}[t]{.44\textwidth} %Cement
	\fcolorbox{black}{white}{ 
		\parbox{1\linewidth}{
			...
			\includegraphics[width=.9\linewidth]{TechnologyGraphs_TechnologyAlignment_Cement.png}}
	}
\end{minipage}
\hspace{.5cm}
\begin{minipage}[t]{.44\textwidth}  %Steel
	\fcolorbox{black}{white}{ 
		\parbox{1\linewidth}{
			...
			\includegraphics[width=.9\linewidth]{TechnologyGraphs_TechnologyAlignment_Steel.png}}
	}
\end{minipage}}
	...
	\begin{minipage}[t]{.45\textwidth} %Aviation
		\fcolorbox{black}{white}{ 
			\parbox{1\linewidth}{
				...
				\includegraphics[width=.9\linewidth]{TechnologyGraphs_TechnologyAlignment_Aviation.png}}
		}
	\end{minipage}
	\hspace{.5cm}
	\begin{minipage}[t]{.45\textwidth} %Shipping
		\fcolorbox{black}{white}{ 
			\parbox{1\linewidth}{
				...
				\includegraphics[width=.9\linewidth]{TechnologyGraphs_TechnologyAlignment_Shipping.png}}
		}
	\end{minipage}
}
...
%\includegraphics[width=1\linewidth, trim={0 3cm 0 0 },clip]{Fig43}
%\newpage
\section*{P23}
...
%CaptionP23a
%
%{\centering\includegraphics[width=.8\linewidth]{Fig41}\par}
%\vspace{-3.8cm}
%
\textbf{CaptionP23b} CaptionP23c
\vspace{-0.8cm}

\includegraphics[width=1\linewidth]{CompanyComposition_Power.png}
\textit{\small SourcePowerFF}
\newpage
\section*{P24}
...
{\centering\includegraphics[width=1\linewidth,trim={0cm 0.2cm 0cm 0cm},clip]{CompanyComposition_Automotive.png}\par}
...
{\centering\includegraphics[width=1\linewidth,trim={0cm 0cm 0cm .2cm},clip]{CompanyComposition_OG.png}\par}
\vspace{-.2cm}
...
\vspace{.2cm}
{\centering\includegraphics[width=.9\linewidth,trim={.2cm 0cm 0cm 1.6cm},clip]{ReportGraphics/FigureP22_EN}\par}
...
\begin{wrapfigure}{r}{0.5\linewidth}
	...
	{\centering\includegraphics[width=1\linewidth,trim={0cm 1cm 0cm 1cm},clip]{ReportGraphics/FigureP23_EN}\par}
...
\includegraphics[width=1\linewidth]{RenewableAdditions.png}
